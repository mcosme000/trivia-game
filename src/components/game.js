...
const Game = () => {
  ...
  const containerStyles = "h-[95%] sm:h-screen flex justify-center items-center"
  const innerContainerStyles = "p-5 md:p-8 h-[70%] md:h-[60%] w-[95%] md:w-[65%] lg:w-[50%] bg-white rounded-md shadow-lg"
